...
<p>
  <a href="https://kutlwano-portfolio.vercel.app/">
    <img src="https://img.shields.io/badge/Portfolio-Live-22c55e?style=for-the-badge" alt="Portfolio" />
  </a>
  <a href="https://www.linkedin.com/in/kutlwano-take-42229431b/">
    <img src="https://img.shields.io/badge/LinkedIn-Connect-0a66c2?style=for-the-badge" alt="LinkedIn" />
  </a>
  <a href="https://github.com/Kutlwano-Take">
    <img src="https://img.shields.io/badge/GitHub-Follow-111827?style=for-the-badge" alt="GitHub" />
  </a>
</p>
...
| Area | Stack |
| --- | --- |
| Cloud | AWS (Lambda, API Gateway, IAM, RDS MySQL, Elastic Beanstalk, CloudFront, S3) |
| IaC | Terraform |
| CI/CD & Deploy | Git, Vercel |
| Security | Security Groups, CORS-hardened deployments |
| Frontend | React |
| Backend | Node.js, Express |
| APIs | REST, API proxying |
| AI / LLM | Google Gemini 1.5 Flash (prompt engineering) |

<p>
  <img src="https://skillicons.dev/icons?i=aws,terraform,docker,kubernetes,linux,git,github,vercel" alt="Cloud tooling" />
</p>
